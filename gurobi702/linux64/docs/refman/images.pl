...
$key = q/m.NumVars;MSF=1.6;AAT/;
$cached_env_img{$key} = q|<IMG
 WIDTH="96" HEIGHT="15" ALIGN="BOTTOM" BORDER="0"
...
$key = q/sumx_{i}^{2}ley^2;MSF=1.6;AAT/;
$cached_env_img{$key} = q|<IMG
